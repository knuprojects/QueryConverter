namespace QueryConverter.Tests.Templates
{
    public static class QueryTemplate
    {
        ...
        public const string InvalidSelectWithFilterAndGroupBy = "SELEdfgdgCT SolarSystem, Galaxy FROM Planets WHERE SpacecraftWithinKilometers< 10000 GROfdsfsUP BY SolarSystem, Galaxy";
        public const string InvalidSelectWithOrderBy = "SELdgdgdgECT Name, Pin FROM Citites ORDER BY Name asc";
    }
}
